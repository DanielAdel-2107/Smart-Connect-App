...
extension AppExtensions on BuildContext {
  ...
  AddMedicalRequestCubit get addMedicalRequestCubit => read<AddMedicalRequestCubit>();
  AddTechnicianRequestCubit get addTechnicianRequestCubit => read<AddTechnicianRequestCubit>();
  //features/it suppoet
  ItSupportCubit get itSupportCubit => read<ItSupportCubit>();
 //features/medical request
  ShowMedicalRequestCubit get showMedicalRequestCubit => read<ShowMedicalRequestCubit>();
  // features/emergancy
    EmergencyCubit get emergencyCubit => read<EmergencyCubit>();
  // features/Technician Request
    TechnicianRequestCubit get technicianRequestCubit => read<TechnicianRequestCubit>();
